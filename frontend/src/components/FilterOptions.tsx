          ...
          <div className='relative'>
            ...
            <div className='relative rounded-xl overflow-hidden'>
              ...
              >
                ...
                {classLevels.map((classLevel: string, i: number) => (
                  <option key={i} value={classLevel}>
                    {classLevel}
                  </option>
                ))}
              </select>
          ...
          <div className='relative'>
            ...
            <div className='relative rounded-xl overflow-hidden'>
              ...
              >
                ...
                {subjectOptions.map((subject: string, i: number) => (
          ...
          <div className='flex flex-wrap justify-center gap-3'>
            {filterMedium && (
              <span className='group relative inline-flex items-center gap-2 px-4 py-2 text-xs font-bold text-blue-600 dark:text-blue-300 bg-blue-50 dark:bg-blue-900/40 rounded-full shadow-sm overflow-hidden'>
                ...
                <svg
                  className='relative w-3.5 h-3.5 text-blue-500 dark:text-blue-400 flex-shrink-0'
                  fill='none'
                  stroke='currentColor'
                  viewBox='0 0 24 24'
                >
