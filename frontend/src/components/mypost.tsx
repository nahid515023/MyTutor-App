...
export default function MyPost (props: {
  ...
  const getProfileImage = () => {
    if (!props.userData || !props.userData.profileImage) {
      return `${process.env.NEXT_PUBLIC_API_URL_IMAGE}/${process.env.NEXT_PUBLIC_DEFULT_IMAGE}`
    }
    return `${process.env.NEXT_PUBLIC_API_URL_IMAGE}/${props.userData.profileImage}`
  }
