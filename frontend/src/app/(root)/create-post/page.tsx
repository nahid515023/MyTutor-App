                    ...
                    <div className='space-y-4'>
                      ...
                      <div className='relative group'>
                        ...
                        <div className='absolute inset-y-0 right-0 flex items-center pr-5 pointer-events-none'>
                          <svg
                            className='w-6 h-6 text-gray-400 dark:text-gray-300 group-hover:text-green-500 transition-colors'
                            fill='none'
                            stroke='currentColor'
                            viewBox='0 0 24 24'
                          >
                    ...
                    <div className='space-y-4'>
                      ...
                      <div className='space-y-4'>
                        <div className='relative group'>
                          ...
                          <div className='absolute inset-y-0 right-0 flex items-center pr-5 pointer-events-none'>
                            <svg
                              className='w-6 h-6 text-gray-400 dark:text-gray-300 group-hover:text-purple-500 transition-colors'
                              fill='none'
                              stroke='currentColor'
                              viewBox='0 0 24 24'
                            >
                    ...
                    <div className='space-y-4'>
                      ...
                      <div className='relative group'>
                        ...
                        <div className='absolute inset-y-0 right-0 flex items-center pr-6 pointer-events-none'>
                          <span className='text-sm text-gray-400 font-medium bg-gray-100 dark:bg-gray-600 px-3 py-1 rounded-lg'>
                            BDT
                          </span>
                        </div>
                      </div>
                  ...
                  <div className='bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800/50 dark:to-gray-700/50 rounded-2xl p-6 border border-gray-200 dark:border-gray-600'>
                    ...
                    <div className='mt-6 p-4 bg-blue-100/80 dark:bg-blue-900/30 rounded-xl border border-blue-200 dark:border-blue-700'>
                      <p className='text-sm text-blue-700 dark:text-blue-300 flex items-center'>
                        ...
                        End time is automatically calculated based on your start
